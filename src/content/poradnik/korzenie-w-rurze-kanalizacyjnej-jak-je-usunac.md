---
title: Korzenie w rurze kanalizacyjnej – skąd się biorą i jak je usunąć
description: Zator, który wraca co kilka miesięcy, to częsty sygnał korzeni w rurze. Piszemy, jak korzenie wciskają się do kanalizacji, po czym je poznać i jak usuwamy je głowicą tnącą i płukaniem wuko – bez rozkopywania ogrodu.
pubDate: 2026-08-20T09:41:37+02:00
category: Zatory
readingTime: 6
faq:
  - q: Po czym poznać, że kanalizację zatykają korzenie?
    a: Najbardziej charakterystyczny sygnał to zator, który wraca co kilka miesięcy mimo czyszczenia, i wolny spływ we wszystkich odpływach domu naraz – bo problem siedzi w rurze za budynkiem, nie przy jednym zlewie. Jeśli do tego nad trasą rury rosną drzewa lub duże krzewy, podejrzenie jest mocne. Pewność daje inspekcja kamerą – na nagraniu widać wiechę korzeni i miejsce, w którym weszły do rury.
  - q: Czy chemia rozpuści korzenie w rurze?
    a: Nie. Korzeń to żywe, twarde drewno – preparaty, które przy świeżym tłuszczowym zatorze potrafią zrobić prześwit, wobec korzeni są bezsilne. Zanim chemia dopłynie do zarośniętego miejsca, rozcieńczy się w ściekach. Korzenie usuwa się mechanicznie, głowicą tnącą.
  - q: Czy usunięcie korzeni wymaga rozkopania ogrodu?
    a: Nie. Sprzęt wprowadzamy przez studzienkę albo rewizję, więc trawnik i kostka zostają nietknięte. Rozkopanie wchodzi w grę dopiero przy wymianie zniszczonego odcinka rury – a o tym, czy jest potrzebna, decyduje obraz z kamery, nie zgadywanie.
  - q: Czy korzenie odrosną po usunięciu?
    a: Mogą, bo wciskają się tą samą nieszczelnością, którą weszły za pierwszym razem. Dlatego po wycięciu oglądamy rurę kamerą i pokazujemy na nagraniu miejsce wejścia. Dalej są dwie drogi – czyszczenie w stałych odstępach, zanim wiecha zdąży zarosnąć przekrój, albo naprawa uszkodzonego łączenia czy odcinka.
  - q: Ile kosztuje usunięcie korzeni z kanalizacji?
    a: Cena zależy od kilku czynników – długości zarośniętego odcinka, tego, jak mocno korzenie wypełniły przekrój, i dostępu do studzienki. Wycenę podajemy przed rozpoczęciem pracy, po krótkiej rozmowie o tym, co się dzieje w instalacji – wystarczy zadzwonić pod 660 360 170.
---
