---
title: Zapchana studzienka kanalizacyjna — po czym to poznać i jak często ją czyścić
description: Cofają się ścieki, czuć odór z kratek, grunt wokół włazu się zapada? Podpowiadamy, po czym poznać zapchaną studzienkę kanalizacyjną i jak często ją czyścić — przy domu i we wspólnocie.
pubDate: 2026-06-20T16:23:47+02:00
category: Studzienki
readingTime: 6
faq:
  - q: Po czym poznać, że problem jest w studzience, a nie w jednym odpływie?
    a: Pojedynczy zatkany odpływ widać tylko w jednym miejscu — wolno schodzi woda w jednym zlewie albo jednej umywalce. Gdy zapycha się studzienka, objawy pojawiają się w kilku punktach naraz, najczęściej najpierw przy odpływach położonych najniżej — w piwnicy, pralni czy garażu. To pierwszy trop, że zbiera się to dalej, poza budynkiem.
  - q: Jak często czyścić studzienkę przy domu jednorodzinnym?
    a: Dla typowego domu rozsądny rytm to przegląd co dwa–trzy lata. Jeśli mieszka więcej osób albo nad posesją rosną drzewa, których korzenie szukają wody, schodzimy bliżej raz na rok. To zalecenia z praktyki, nie sztywny przepis — każda instalacja zbiera osad we własnym tempie.
  - q: Czy zapadnięty grunt wokół włazu to objaw zapchanej studzienki?
    a: Może nim być. Mokra, grząska ziemia albo lekkie zapadnięcie wokół włazu oznacza, że woda nie spływa tam, gdzie powinna, tylko podsiąka w grunt. Warto wtedy zajrzeć do środka, zanim z odpływów zacznie wracać woda.
  - q: Kto odpowiada za studzienkę w bloku albo we wspólnocie?
    a: Studzienka i poziome odcinki kanalizacji to część wspólna nieruchomości, więc dba o nie wspólnota albo zarządca. Lokator odpowiada za instalację w swoim mieszkaniu, do pierwszego odgałęzienia. Dlatego studzienki najlepiej trzymać w planie przeglądów budynku, a nie czekać, aż zacznie się cofać.
  - q: Czym czyścicie zapchaną studzienkę?
    a: Mamy różny sprzęt na różne sytuacje. Sam osad z dna to dopiero połowa roboty — kanał między studzienkami też potrafi być obrośnięty, więc po wybraniu mułu płuczemy odcinki ciśnieniowo (wuko). Jeśli nie wiadomo, gdzie dokładnie siedzi zator, najpierw puszczamy kamerę inspekcyjną. Zadzwoń pod 660 360 170, ustalimy termin i orientacyjny koszt.
---
